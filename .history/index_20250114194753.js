...
async function startServer() {
  ...
  app.post("/api/mint-nft", async (req, res) => {
    try {
        ...
        console.log("Step 1: Wallet Address Received", walletAddress);

        // Step 1: Generate mint
        const mint = Keypair.generate();
        console.log("Step 2: Mint Keypair Generated", mint.publicKey.toBase58());
        ...
        console.log("Step 3: Metadata Prepared", metadata);

        // Step 3: Calculate required space
        const mintSpace = getMintLen([]);
        const metadataSpace = pack(metadata).length;
        console.log("Step 4: Space Calculated", { mintSpace, metadataSpace });

        const lamports = await connection.getMinimumBalanceForRentExemption(
            mintSpace + metadataSpace
        );
        console.log("Step 5: Lamports Calculated", lamports);
        ...
        console.log("Step 6: Mint Account Created");
        ...
        console.log("Step 7: Mint Initialized");
        ...
        console.log("Step 8: Mint To Instruction Created");
        ...
        console.log("Step 9: Metadata Initialized");
        ...
        console.log("Step 10: Transaction Prepared");

        // Sign and send the transaction
        const signature = await connection.sendTransaction(transaction, [payer, mint]);
        console.log("Step 11: Transaction Sent", signature);
