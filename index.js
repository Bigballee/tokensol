...
async function startServer() {
  ...
  app.post("/mint-nft", async (req, res) => {
    try {
      ...
      const [associatedTokenAccount, bump] = PublicKey.findProgramAddressSync(
        [
      ...
      if (!associatedTokenAccountInfo) {
        ...
        createAssociatedAccountIx = createAssociatedTokenAccountInstruction(
          ...
          associatedTokenAccount, // The associated token account for the recipient
      ...
      const mintToIx = createMintToInstruction(
        mint.publicKey,
        associatedTokenAccount, // Recipient's associated token account
        payer.publicKey, // Mint authority
